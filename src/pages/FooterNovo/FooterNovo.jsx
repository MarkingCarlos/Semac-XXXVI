    ...
    <div className="coluna">
      ...
      <div className="colunaLinks">
        {links.map(({ texto, href }) => (
          <a key={texto} href={href} className="linkNavegacao">{texto}</a>
        ))}
      </div>
    </div>
  );
...
const LINKS_NAVEGACAO = [
  { texto: 'Início', href: '#' },
  { texto: 'Programação', href: '#' },
  { texto: 'Inscrição', href: '#' },
  { texto: 'Patrocinadores', href: '#' },
  { texto: 'Sobre', href: '#' },
];
...
const LINKS_PARTICIPANTE = [
  ...
  { texto: 'Certificados', href: '#' },
  { texto: 'Transmissão ao vivo', href: '#' },
];
