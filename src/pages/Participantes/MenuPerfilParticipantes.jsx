/* Menu da conta no cabeçalho: o avatar com as iniciais abre um painel com
   a identidade da pessoa e a volta pra página principal (sem derrubar a
   sessão). O "sair da conta" fica na aba Perfil. */

import { useEffect, useRef, useState } from 'preact/hooks';

export default function MenuPerfilParticipantes({ nome, email, iniciais, onIrParaPaginaPrincipal }) {
